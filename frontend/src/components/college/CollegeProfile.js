...
export default function CollegeProfile(props) {
    const [college, setCollege] = useState({ name: "Wagner College", ranking: "9", adm_rate: "40%", size: "8000", SAT_math: "800", SAT_EBRW: "800", ACT_composite: "36", in_state_cost: "9000", out_state_cost: "30000", institution_type: "Public", grad_debt_median: "3000", completion_rate: "90%", address: "100 Circle Rd, Stony Brook, NY, 11224" });
